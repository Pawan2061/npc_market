...
export function getNpcMarketProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...NpcMarketIDL, address: address ? address.toBase58() : NpcMarketIDL.address } as NpcMarket, provider)
}
